...
class Email {
	...
	public function control_button() {
		...
		<li class="list-group-item" data-type="<?php echo __CLASS__ ?>" for="Email">
			<span class="lfi lfi-name"></span> Email
			<a title="Email" rel="Email" class="add" data-template='Email' href="#"><i class="glyphicon glyphicon-plus-sign pull-right ttipf" title=""></i></a>
		</li>
	    <?php
