...
class Username {
	...
	public function control_button() {
		ob_start();
		?>
		<li class="list-group-item" data-type="<?php echo __CLASS__ ?>" for="Username">
			<span class="lfi lfi-name"></span> Name
			<a title="Username" rel="Username" class="add" data-template='Name' href="#"><i class="glyphicon glyphicon-plus-sign pull-right ttipf" title=""></i></a>
		</li>
	    <?php
