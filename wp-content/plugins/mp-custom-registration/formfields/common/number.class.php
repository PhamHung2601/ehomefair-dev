...
class Number {
	...
	public function control_button() {
		...
		<li class="list-group-item" data-type="<?php echo __CLASS__ ?>" for="Number">
			<span class="lfi lfi-name"></span> Number
			<a title="Number" rel="Number" class="add" data-template='Number' href="#"><i class="glyphicon glyphicon-plus-sign pull-right ttipf" title=""></i></a>
		</li>
	    <?php
