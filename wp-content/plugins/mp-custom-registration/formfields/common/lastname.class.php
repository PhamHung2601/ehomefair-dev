...
class Lastname {
	...
	public function control_button() {
		ob_start();
		?>
		<li class="list-group-item" data-type="<?php echo __CLASS__ ?>" for="lastname">
			<span class="lfi lfi-name"></span> Last Name
			<a title="Last Name" rel="Lastname" class="add" data-template='Name' href="#"><i class="glyphicon glyphicon-plus-sign pull-right ttipf" title=""></i></a>
		</li>
	    <?php
