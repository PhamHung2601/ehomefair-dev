...
class Phone {
	...
	public function control_button() {
		...
		<li class="list-group-item" data-type="<?php echo __CLASS__ ?>" for="Phone">
			<span class="lfi lfi-name"></span> Phone
			<a title="Phone" rel="Phone" class="add" data-template='Phone' href="#"><i class="glyphicon glyphicon-plus-sign pull-right ttipf" title=""></i></a>
	</li>
	    <?php
...
?>
	...
	public function field_preview_html($params = array()) {
		...
		<div class='form-group'>
			<div class='row'>
				<div class='col-md-3'>
					<input type='text' disabled='disabled' class='form-control' name='submitform[][country_code]' value='' placeholder='Country' <?php echo mpCustomRequired($params) ?>/>
				</div>
				<div class='col-md-3'>
					<input type='text' disabled='disabled' class='form-control' name='submitform[][area_code]' value='' placeholder='Area' <?php echo mpCustomRequired($params) ?>/>
				</div>
				<div class='col-md-6'>
					<input type='text' disabled='disabled' class='form-control' name='submitform[][dial_code]' value='' placeholder='Number' <?php echo mpCustomRequired($params) ?>/>
				</div>
			</div>
		</div>
		<?php
	...
	?>
		<div id="<?php echo $params['id'] ?>" class='form-group <?php if (isset($params['conditioned'])) echo " conditioned hide "?>' data-cond-fields="<?php echo $condition_fields ?>" data-cond-action="<?php echo $cond_action.':'.$cond_boolean ?>" >
			...
			<div class='form-group'>
				<div class='row'>
					<div class='col-md-3'>
						<input type='text' class='form-control' value='<?php if( $value_field != '' && $value_field['country_code'] != '' ) echo $value_field['country_code'];?>' name='submitform[<?php echo $params['id']?>][country_code]' value='' placeholder='Country' <?php echo mpCustomRequired($params) ?>/>
					</div>
					<div class='col-md-3'>
						<input type='text' class='form-control' value='<?php if( $value_field != '' && $value_field['area_code'] != '' ) echo $value_field['area_code'];?>' name='submitform[<?php echo $params['id'] ?>][area_code]' value='' placeholder='Area' <?php echo mpCustomRequired($params) ?>/>
					</div>
					<div class='col-md-6'>
						<input type='text' class='form-control' value='<?php if( $value_field != '' && $value_field['dial_code'] != '' ) echo $value_field['dial_code'];?>' name='submitform[<?php echo $params['id'] ?>][dial_code]' value='' placeholder='Number' <?php echo mpCustomRequired($params) ?>/>
					</div>
				</div>
			</div>
		</div>
