...
<form class="form" id="form" role="form" action="?section=contact-forms&view=submit" method="POST" enctype="multipart/form-data" >
    ...
    <div class="form-group">
        <label for="field_" style="display: block;clear: both"><?php echo $cur_pref['label'] ?></label>
        <?php
    ...
    ?>
    <!-- <button type="submit" id="submit" class="btn btn-info btn-block"><?php //echo ((isset($formsetting_raw['buttontext'])==false||$formsetting_raw['buttontext']=='')?"Submit":$formsetting_raw['buttontext']) ?></button> -->
</form>
</div>
<div class="pull-right"><small><em>powered by <a href="<?php echo base_url() ?>" target="_blank">LiveForm.org</a></em></small></div>
</div>
