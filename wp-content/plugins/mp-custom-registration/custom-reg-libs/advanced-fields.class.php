<?php
class mpcustomadvance {
    public static function file($params = array()) {         
        $input_field = "<input type='file' name='upload[{$params['id']}]'".mpCustomRequired($params).">";
        return $input_field;
    }
    ...
    public static function fullname($params = array()) {
		$title = "<label for='title'>Title: </label><input class='form-control' type='text' name='submitform[".e($params['id'],"")."][title]' id='title' ".mpCustomRequired($params)." /><br/>";
        $first_name = "<label for='first-name'>First name: </label><input class='form-control' type='text' name='submitform[".e($params['id'],"")."][first_name]' id='first_name' ".mpCustomRequired($params)." /><br/>";
        $last_name = "<label for='last-name'>Last name: </label><input class='form-control' type='text' name='submitform[".e($params['id'],"")."][last_name]' id='last_name' ".mpCustomRequired($params)." />";
    ...
    public static function address($params = array()) {
        $street1 = "<div class='row'><div class='col-md-12'><input class='form-control row-bottom-buffer' type='text' name='submitform[".e($params['id'],"")."][address1]' id='street1'".ph("Address 1").mpCustomRequired($params)." /></div></div>";
        $street2 = "<div class='row'><div class='col-md-12'><input class='form-control row-bottom-buffer' type='text' name='submitform[".e($params['id'],"")."][address2]' id='street2'".ph("Address 2").mpCustomRequired($params)." /></div></div>";
        $city = "<div class='row'><div class='col-md-12'><input class='form-control row-bottom-buffer' type='text' name='submitform[".e($params['id'],"")."][city]' id='city'".ph("City").mpCustomRequired($params)." /></div></div>";
		...
		$countries_select = ""
				. "<select data-placeholder='Choose a country' style='width: 100%' class='select2element' id='{$params['id']}_selector_country' name='submitform[{$params['id']}][country]'".mpCustomRequired($params).">"
				. "<option value='none'>Choose a country</option>"
				. $countries_option_html 
				. "</select>";

		$state_select = "<select data-placeholder='Choose a state' style='width: 100%' class='select2element' id='{$params['id']}_selector_state' name='submitform[{$params['id']}][state]'".mpCustomRequired($params).">"
    ...
    public static function payment( $params = array() ) {
        ...
        $methods = "<select class='form-control' name=submitform[".e($params['id'],"")."] id='payment' ".mpCustomRequired($params).">";
	...
	public static function url( $params = array() ) {
		...
		$website_url_html = "";
		$website_url_html .= "<input type='text' class='form-control' name=submitform[".e($params['id'],"")."] id='urlfield_{$params['id']}' ".mpCustomRequired($params)." placeholder='http://www.website.com'/>";
	...
	public static function date( $params = array() ) {
		...
		$date_field_html = "";
				$date_field_html .= "<input class='form-control datepicker' type='text' name='submitform[{$params['id']}]' id='{$datepicker_field_id}'".mpCustomRequired($params)."/>";
...
$( '#{$datepicker_field1_id}' ).datepicker( 'option', 'maxDate', selectedDate );
		...
		$date_field_html .= "<div class='col-md-6'><input class='form-control datepicker' type='text' placeholder='From' name='submitform[{$params['id']}][from]' id='{$datepicker_field1_id}'".mpCustomRequired($params)."/></div>";
		$date_field_html .= "<div class='col-md-6'><input class='form-control datepicker' type='text' placeholder='To' name='submitform[{$params['id']}][to]' id='{$datepicker_field2_id}'".mpCustomRequired($params)."/></div>";
		$date_field_html .= "</div>";
	...
	public static function phone( $params = array() ) {
		$country_code_template = "<div class='col-md-3'><input type='text' class='form-control' name='submitform[{$params['id']}][country_code]' value='' placeholder='Country'".mpCustomRequired($params)."/></div>";
		$area_code_template = "<div class='col-md-3'><input type='text' class='form-control' name='submitform[{$params['id']}][area_code]' value='' placeholder='Area'".mpCustomRequired($params)."/></div>";
		$dial_code_template = "<div class='col-md-6'><input type='text' class='form-control' name='submitform[{$params['id']}][dial_code]' value='' placeholder='Number'".mpCustomRequired($params)."/></div>";
	...
	public static function rating( $params = array() ) {
		...
		$input_field = "<input type='hidden' name='submitform[{$params['id']}]' id='{$params['id']}_rating_field' " . mpCustomRequired($params) . " />";
