...
jQuery(function ($) {
    ...
    var toggle_events = {
        ...
        triggerOnPageLoad: function () {
            $('#get_included_categories').select2();
            $('#get_excluded_categories').select2();
        ...
        get_payment_settings: function ($payment_settings) {
            ...
            if (true === $payment_settings) {
                ...
                if (!sumo_pp_admin_bulk_action_settings.is_custom_frontend) {
        ...
        addPlanSearchField: function (col) {
            ...
            $.ajax({
                ...
                data: {
                    ...
                    security: sumo_pp_admin_bulk_action_settings.plan_search_nonce,
                    rowID: rowID,
                    col: col,
                },
    ...
    var updater = {
         ...
         */
        init: function () {
            $(document).on('click', '#bulk_update_products', this.initProduct);
        },
        initProduct: function () {
            $('tr.bulk-update-products').find('.spinner').addClass('is-active');

            updater.start('bulk_update_products', {
                security: sumo_pp_admin_bulk_action_settings.products_nonce,
