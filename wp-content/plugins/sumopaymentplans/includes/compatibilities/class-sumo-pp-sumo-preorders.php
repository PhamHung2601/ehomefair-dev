...
//            remove_filter( 'woocommerce_product_get_price', array( _sumo_wcpo()->cart, 'set_preorder_price' ), 999, 2 ) ;
//            remove_filter( 'woocommerce_product_variation_get_price', array( _sumo_wcpo()->cart, 'set_preorder_price' ), 999, 2 ) ;
        }
        return $product_props ;
    }
    ...
    public function schedule_as_cancelled( $next_eligible_status , $payment ) {
