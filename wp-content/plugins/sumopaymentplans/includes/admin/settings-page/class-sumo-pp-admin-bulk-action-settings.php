...
class SUMO_PP_Bulk_Action_Settings extends SUMO_PP_Abstract_Settings {
        ...
        <tr>
            ...
            <td>
                <select name="get_product_select_type" id="get_product_select_type">
                    ...
                    <option value="included-products" <?php selected( 'included-products' === get_option( "bulk{$this->prefix}get_product_select_type", 'all-products' ), true ) ; ?>><?php _e( 'Include Products', $this->text_domain ) ; ?></option>
                    <option value="excluded-products" <?php selected( 'excluded-products' === get_option( "bulk{$this->prefix}get_product_select_type", 'all-products' ), true ) ; ?>><?php _e( 'Exclude Products', $this->text_domain ) ; ?></option>
                    <option value="included-categories" <?php selected( 'included-categories' === get_option( "bulk{$this->prefix}get_product_select_type", 'all-products' ), true ) ; ?>><?php _e( 'Include Categories', $this->text_domain ) ; ?></option>
                    <option value="excluded-categories" <?php selected( 'excluded-categories' === get_option( "bulk{$this->prefix}get_product_select_type", 'all-products' ), true ) ; ?>><?php _e( 'Exclude Categories', $this->text_domain ) ; ?></option>
                </select>
            </td>
        </tr>
        <?php
    ...
    public function get_include_product_selector() {
        ...
        _sumo_pp_wc_search_field( array(
            ...
            'title'       => __( 'Select Product(s) to Include', $this->text_domain ),
    ...
    public function get_exclude_product_selector() {
        ...
        _sumo_pp_wc_search_field( array(
            ...
            'type'        => 'product',
            'action'      => 'woocommerce_json_search_products_and_variations',
            'title'       => __( 'Select Product(s) to Exclude', $this->text_domain ),
            'placeholder' => __( 'Search for a product&hellip;', $this->text_domain ),
    ...
    public function get_include_product_category_selector() {
        ...
        <tr>
            <th>
                <?php _e( 'Select Categorie(s) to Include', $this->text_domain ) ; ?>
            </th>
            <td>                
    ...
    public function get_exclude_product_category_selector() {
        ...
        <tr>
            <th>
                <?php _e( 'Select Categorie(s) to Exclude', $this->text_domain ) ; ?>
            </th>
            <td>                
    ...
    public function get_update_button_for_products() {
        ...
        <tr class="bulk-update-products">
            <td>
                <input type="button" id="bulk_update_products" class="button-primary" value="<?php _e( 'Save and Update', $this->text_domain ) ; ?>" />
                <span class="spinner"></span>
            </td>
        </tr>
        <?php
