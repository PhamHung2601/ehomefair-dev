    ...
    public function get_settings() {
        ...
        return apply_filters( 'sumopaymentplans_get_' . $this->id . '_settings', array(
            ...
            array(
                ...
                'type'    => 'textarea',
                'std'     => __( '<small style="color:#777;">Total <strong>[sumo_pp_total_payable]</strong> payable</small>', $this->text_domain ),
                'default' => __( '<small style="color:#777;">Total <strong>[sumo_pp_total_payable]</strong> payable</small>', $this->text_domain ),
            ),
            array(
            ...
            array(
                ...
                'type'    => 'textarea',
                'std'     => __( '<br><small style="color:#777;">Balance <strong>[sumo_pp_balance_payable]</strong> payable</small>', $this->text_domain ),
                'default' => __( '<br><small style="color:#777;">Balance <strong>[sumo_pp_balance_payable]</strong> payable</small>', $this->text_domain ),
            ),
            array(
            ...
            array(
                'name'     => __( 'Total Payable Amount', $this->text_domain ),
                'id'       => $this->prefix . 'total_payable_amount_label',
                'newids'   => $this->prefix . 'total_payable_amount_label',
                'type'     => 'textarea',
                'std'      => __( 'Total Payable Amount', $this->text_domain ),
                'default'  => __( 'Total Payable Amount', $this->text_domain ),
                'desc_tip' => __( 'To display label under "Cart Totals"', $this->text_domain ),
            ),
