    ...
    public function get_settings() {
        ...
        return apply_filters( 'sumopaymentplans_get_' . $this->id . '_settings', array(
            ...
            array(
                ...
                'desc_tip' => __( 'If enabled, time will be displayed in single product page, cart page, checkout page and my account page.', SUMO_PP_PLUGIN_TEXT_DOMAIN ),
            ),
            array(
                'name'    => __( 'Grant Permission to Download Files of Downloadable Products after', $this->text_domain ),
                ...
                'options' => array(
                    'initial-payment' => __( 'Initial Payment', $this->text_domain ),
                    'final-payment'   => __( 'Final Payment', $this->text_domain ),
                ),
            ),
            array(
            ...
            array(
                'name'     => __( 'Use Deposit/Payment Plan Variation Form Template.', $this->text_domain ),
                'id'       => $this->prefix . 'variation_form_template',
                'newids'   => $this->prefix . 'variation_form_template',
                'type'     => 'select',
                'options'  => array(
                    'from-woocommerce' => __( 'From WooCommerce', $this->text_domain ),
                    'from-plugin'      => __( 'From Plugin', $this->text_domain ),
                ),
                'std'      => 'from-woocommerce',
                'default'  => 'from-woocommerce',
                'desc'     => __( 'If the Deposit/Payment Plan variations or not displaying in Single Product page, then try using "From Plugin" option.', $this->text_domain ),
                'desc_tip' => true,
            ),
