...
<?php if( $order->has_status( 'pending' ) ) : ?>
    ...
    <p><?php printf( __( 'Hi, <br>This is to remind you that balance payment for Payment #%s will be automatically charged on <b>%s</b> because you have already preapproved for automatic charging. <br>Kindly make sure you have sufficient funds in your account.' , SUMO_PP_PLUGIN_TEXT_DOMAIN ) , $payment->get_payment_number() , _sumo_pp_get_date_to_display( $payment->get_prop( 'next_payment_date' ) ) ) ; ?></p>
