...
/**
 * @author Webkul
 * @implements Admin_Chatbox_Interface
 */

namespace WpMarketplaceBuyerSellerChat\Templates\Admin;

use WpMarketplaceBuyerSellerChat\Templates\Admin\Util;
...
if (! class_exists('Mpbs_Admin_Chatbox')) {
    
    class Mpbs_Admin_Chatbox implements Util\Admin_Chatbox_Interface
    {
        /**
         * Admin chatbox
         */
