 ...
 * Activation handler
 *
 * @package     Woocommerce Marketplace Tablerate Shipping\ActivationHandler
 * @since       1.0.0
 */
...
class MP_TableRate_Activation {
    ...
    public function __construct( $plugin_path, $plugin_file ) {
        ...
        // Set plugin name
        $this->plugin_name = 'Marketplace Table Rate Shipping';
    ...
    public function run() {
        // Display notice
        add_action( 'admin_notices', array( $this, 'notify_me' ) );
    }
