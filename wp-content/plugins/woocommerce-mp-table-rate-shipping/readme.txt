...
= 1.8 =
* Added option for admin to add shipping for their products.
* Added feature of global shipping and global shipping for regions.
* Changed the flow for calculate shipping.
* Fix issue of no shipping available if cart having different seller products by global shipping method.

= 1.7.1 =
* Fix: Issue with applying table rate shipping even if it is disabled in settings.
* Fixed css of the select field.

= 1.7.0 =
* Compatiable with woocommerce 3.0.
