...
$result = '
	<div style="margin-bottom: 40px;">
		<p>' . utf8_decode( sprintf( esc_html__( 'Just to let you know, we have received your order #%s, and it is now being processed:', 'marketplace' ), esc_html( $order->get_order_number() ) ) ) . '</p>
