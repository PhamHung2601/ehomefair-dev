...
$result = '
	<div style="margin-bottom: 40px;">
		<p>' . utf8_decode( esc_html__( "Thanks for your order. It is on-hold until we confirm that payment has been received. In the meantime, here is a reminder of what you ordered:", 'marketplace' ) ) . '</p>
