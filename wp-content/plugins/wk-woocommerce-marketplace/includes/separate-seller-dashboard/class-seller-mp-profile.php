...
<div class="wk_profileupdate woocommerce-MyAccount-content" style="width: 60%;">
	...
	<div class="wkmp_profile_preview_link">
		...
		<a href="<?php echo esc_url( site_url() . '/' . $page_name . '/' . get_option( 'mp_store', 'store' ) . '/' . $user_meta_arr['shop_address'] ); ?>" class="button button-primary" target="_blank"><?php echo esc_html__( 'View Profile', 'marketplace' ); ?></a>
	</div>
